<?php
	...
	echo "</br> resultadoAvionTipo1: $resultadoAvionTipo1";
	echo "</br> resultadoAvionTipo2: $resultadoAvionTipo2";
	echo "</br> resultadoAvionTipo3: $resultadoAvionTipo3";
	echo "</br> resultadoAvionTipo4: $resultadoAvionTipo4";
	echo "</br>";
